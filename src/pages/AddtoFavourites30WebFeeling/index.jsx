...
const AddtoFavourites30WebFeelingPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto pb-[52px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-poppins gap-[34px] items-start justify-between max-w-[2479px] mt-[23px] mx-auto md:px-5 w-full">
            <div className="h-[1730px] md:h-[1828px] sm:h-[3279px] relative w-[98%] md:w-full">
              <div className="absolute bottom-[0] h-[1264px] left-[19%] w-[57%] md:w-full">
                ...
                <Input
                  ...
                  className="font-bold justify-center leading-[normal] md:text-[33px] p-0 placeholder:text-gray-700 sm:text-[31px] text-[35px] text-left w-full"
                  wrapClassName="absolute border border-light_blue-900 border-solid inset-[0] m-auto w-[86%]"
                ></Input>
                <Img
              ...
              <div className="absolute bg-white-A700_01 border border-light_blue-800 border-solid flex flex-col inset-x-[0] items-center justify-start mx-auto p-[30px] sm:px-5 rounded-[30px] shadow-bs5 top-[0] w-full">
                <div className="flex flex-col items-center justify-start mb-[133px] w-[97%] md:w-full">
                  <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
                    <Text
                      className="sm:mt-0 mt-[19px] sm:text-4xl md:text-[38px] text-[40px] text-black-900"
                      size="txtPoppinsBold40"
                    >
                      My Favourites
                    </Text>
                    <Text
                      className="mb-[19px] sm:text-4xl md:text-[38px] text-[40px] text-black-900"
                  ...
                  <List
                    className="sm:flex-col flex-row md:gap-10 gap-[212px] grid sm:grid-cols-1 md:grid-cols-3 grid-cols-5 justify-center mt-[383px] w-[95%]"
                    orientation="horizontal"
                  >
                    <div className="md:h-[235px] h-[273px] relative w-full">
                      <div className="absolute bottom-[0] h-[235px] inset-x-[0] mx-auto w-[97%]">
                    ...
                    <div className="md:h-[235px] h-[276px] relative w-full">
                      <div className="absolute bottom-[0] h-[235px] inset-x-[0] mx-auto w-[97%]">
                        <div className="bg-light_blue-900 h-[235px] m-auto rounded-[136px] shadow-bs9 w-full"></div>
                        <Text
                          className="absolute inset-x-[0] mx-auto sm:text-4xl md:text-[38px] text-[40px] text-white-A700 top-[34%] w-max"
                  ...
                  <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex md:flex-col flex-row gap-[34px] items-center justify-center mt-[406px] p-1 rounded-[50px] w-[37%] md:w-full">
                    <Img
                      className="h-[125px] md:ml-[0] ml-[26px]"
                      src="images/img_iconheartadd.svg"
                      alt="iconheartadd"
                    />
                    <Text
                      className="mr-[104px] md:text-5xl text-6xl text-center text-light_blue-900"
...
export default AddtoFavourites30WebFeelingPage;
