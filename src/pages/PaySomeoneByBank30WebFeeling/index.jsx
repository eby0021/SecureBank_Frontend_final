...
const PaySomeoneByBank30WebFeelingPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto pb-[52px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-poppins gap-[34px] items-start justify-between max-w-[2456px] mt-[13px] mx-auto md:px-5 w-full">
            <div className="flex flex-col items-start justify-start">
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between w-[98%] md:w-full">
                <div className="flex flex-col gap-[5px] justify-start w-[36%] md:w-full">
                  ...
                  <List
                    className="sm:flex-col flex-row md:gap-10 gap-[206px] grid md:grid-cols-1 grid-cols-2 ml-10 md:ml-[0] w-[96%]"
              ...
              <Line className="bg-black-900_72 h-0.5 mt-[75px] w-full" />
              <div className="bg-white-A700_01 border border-light_blue-800 border-solid flex flex-col items-center justify-end md:ml-[0] ml-[228px] mt-11 p-7 sm:px-5 rounded-[30px] shadow-bs5 w-3/4 md:w-full">
                <div className="flex flex-col gap-[30px] items-center justify-start w-[68%] md:w-full">
                  <Img
                    className="h-[179px]"
                  ...
                  <div className="flex flex-col items-start justify-start w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                      <div className="h-28 relative w-2/5 md:w-full">
                        ...
                        <div className="absolute bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row h-full inset-[0] items-center justify-between m-auto p-6 sm:px-5 rounded-tl-[30px] rounded-tr-[30px] w-full">
                          <Text
                          ...
                          <div className="bg-light_blue-900 border-2 border-light_blue-900 border-solid h-[47px] mr-[19px] my-[7px] rounded-[23px] w-[47px]"></div>
                        </div>
                      </div>
                      <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex md:flex-1 flex-row gap-[67px] items-center justify-end p-[26px] sm:px-5 rounded-[30px] w-2/5 md:w-full">
                        <Text
                          className="mb-1.5 sm:text-[31px] md:text-[33px] text-[35px] text-black-900"
                          size="txtPoppinsBold35Black900"
                        >
                          PAY Someone{" "}
                        </Text>
                        <div className="bg-white-A700 border-2 border-light_blue-900 border-solid h-[47px] mr-2 my-[5px] rounded-[23px] w-[47px]"></div>
                      </div>
                    </div>
                    <div className="md:h-2 h-[5px] mt-[3px] relative w-2/5 sm:w-full">
                    ...
                    <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row sm:gap-10 items-center justify-between md:ml-[0] ml-[211px] mt-[43px] p-3.5 rounded-[10px] w-[65%] md:w-full">
                      <Text
                        className="mb-0.5 ml-2 mt-[13px] sm:text-[31px] md:text-[33px] text-[35px] text-gray-700"
                    ...
                    <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row sm:gap-10 items-center justify-between md:ml-[0] ml-[211px] mt-12 p-3.5 rounded-[10px] w-[65%] md:w-full">
                      <Text
                        className="mb-0.5 ml-2 mt-[13px] sm:text-[31px] md:text-[33px] text-[35px] text-gray-700"
                        size="txtPoppinsBold35"
                      >
                    ...
                    <div className="bg-white-A700 border border-light_blue-900 border-solid flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[73px] px-[7px] rounded-tl-[10px] rounded-tr-[10px] w-full">
                      <Img
                      ...
                      <Img
                        className="md:flex-1 h-[74px] sm:h-auto md:ml-[0] ml-[528px] md:mt-0 mt-[15px] object-cover rounded-[10px] w-[12%] md:w-full"
                        src="images/img_keyboard8419852.png"
                        alt="keyboard8419852"
                      />
                    </div>
                    <Line className="bg-light_blue-900 h-[5px] mt-1.5 w-full" />
                    <div className="bg-white-A700 border border-light_blue-900 border-solid flex sm:flex-col flex-row sm:gap-10 gap-[193px] items-center justify-start md:ml-[0] ml-[211px] mt-[70px] p-3 rounded-tl-[10px] rounded-tr-[10px] w-[65%] md:w-full">
                      <Text
                        className="sm:text-[31px] md:text-[33px] text-[35px] text-gray-700"
                        size="txtPoppinsBold35"
                      >
                        Payment Description
                      </Text>
                      <Img
                        className="h-[74px] md:h-auto mb-1.5 object-cover rounded-[10px] w-[18%] sm:w-full"
                        src="images/img_keyboard8419852.png"
                        alt="keyboard8419852_One"
                      />
                    </div>
                    <Text
                      className="bg-light_blue-900 h-[89px] justify-center md:ml-[0] ml-[308px] mt-[76px] pb-3.5 pt-1.5 sm:px-5 px-[35px] rounded-[44px] sm:text-[35px] md:text-[41px] text-[45px] text-center text-white-A700 w-[558px]"
            ...
            <div className="bg-gray-700_01 h-[809px] mb-[720px] md:mt-0 mt-[206px] rounded-[10px] w-[1%]"></div>
          </div>
          <Line className="bg-black-900_72 h-0.5 mt-[87px] w-full" />
          <Text
...
export default PaySomeoneByBank30WebFeelingPage;
