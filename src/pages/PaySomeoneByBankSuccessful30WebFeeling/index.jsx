...
const PaySomeoneByBankSuccessful30WebFeelingPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto pb-[52px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row font-poppins gap-[34px] items-start justify-between max-w-[2456px] mt-3.5 mx-auto md:px-5 w-full">
            <div className="flex flex-col items-center justify-start">
              ...
              <Line className="bg-black-900_72 h-0.5 mt-[74px] w-full" />
              <div className="bg-white-A700_01 border border-light_blue-800 border-solid flex flex-col items-center justify-start mt-[60px] p-[13px] rounded-[30px] shadow-bs5 w-[64%] md:w-full">
                <Img
                  ...
                  alt="iconmoneyrecive"
                />
                <div className="md:h-[1132px] h-[813px] sm:h-[895px] mt-9 relative w-[79%] md:w-full">
                  <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
                    <div className="flex flex-col gap-[25px] items-center justify-start w-full">
                      ...
                      <div className="flex flex-col items-start justify-start w-full">
                        <div className="bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row gap-[67px] items-center justify-start p-[25px] sm:px-5 rounded-tl-[30px] rounded-tr-[30px] w-2/5 md:w-full">
                          <Text
                          ...
                          <div className="bg-light_blue-900 border-2 border-light_blue-900 border-solid h-[47px] my-1.5 rounded-[23px] w-[47px]"></div>
                        </div>
                  ...
                  <div className="absolute bg-white-A700 border-2 border-light_blue-900 border-solid flex flex-row items-center justify-between p-7 sm:px-5 right-[1%] rounded-[30px] top-[10%] w-2/5">
                    <Text
                  ...
                  <div className="absolute bg-white-A700_01 border border-light_blue-800 border-solid flex flex-col items-center justify-end p-[90px] md:px-10 sm:px-5 right-[0] rounded-[30px] shadow-bs5 top-[0] w-[86%]">
                    ...
                    <Text
                      className="mt-[76px] sm:text-[40px] md:text-[46px] text-[50px] text-black-900"
                      size="txtPoppinsBold50Black900"
                    >
                      $500 Transferred Successfully{" "}
                    </Text>
                    <Text
                      className="bg-light_blue-900 h-[82px] justify-center mt-[71px] pb-2.5 pt-[15px] sm:px-5 px-[35px] rounded-[41px] sm:text-[33px] md:text-[35px] text-[37px] text-center text-white-A700 w-[381px]"
            ...
            <div className="bg-gray-700_01 h-[809px] mb-[724px] md:mt-0 mt-[205px] rounded-[10px] w-[1%]"></div>
          </div>
...
export default PaySomeoneByBankSuccessful30WebFeelingPage;
